...
public class ConfigTool
{
    ...
    public static boolean genPrjConfigs(Class<?> clazz, String mainFrameTitle, String mainFrameClass)
    {
        ...
        try
        {
            ...
            //适时添加定时器的配置项信息
            if (StringUtils.isNotEmpty(PropertyUtils.get(configFile, "JOB_CONFIG")) || StringUtils.isNotEmpty(PropertyUtils.get(configFile, "JOB_SCAN_PACKAGE")) || ClassKit.getPackageAllClasses(WinMgr.DEFAULT_JOB_SCAN_PACKAGE).size() > 0)
            {
